...
r = JmxThreadGroup.objects.get(id=69)
print(r.jmx)
# #
...
base = '/Users/chenlei/python-project/jmeter_platform/performance_files/jmx/template.jmx'
new = '/Users/chenlei/python-project/jmeter_platform/performance_files/jmx/template2.jmx'

shutil.copyfile(base, new)
